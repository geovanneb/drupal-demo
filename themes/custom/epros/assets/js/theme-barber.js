        ...
        if (jQuery(window).width() > 767) {
                ...
                jQuery(window).scroll(function(e) {
                    ...
                    if( scrollTopDistance > 200 ) {
                        jQuery(".navbar-brand,.primary-navbar > li, .top-right").css({ paddingTop: "6px", paddingBottom: "6px"});
                        jQuery(".primary-navbar").removeClass("default-border").addClass("after-fix");
                    } else {
                         jQuery(".navbar-brand,.primary-navbar > li, .top-right").css({ paddingTop: "20px", paddingBottom: "20px"});
                         jQuery(".primary-navbar").removeClass("after-fix").addClass("default-border");
                    }
                });
        }
